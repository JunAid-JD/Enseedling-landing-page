  ...
  return (
    ...
    >
      ...
      <main>
        <div className="body">
          <h1>
            Empower your business by transforming your ideas into captivating
            applications
          </h1>
          <p>
            Construct seamless Application that improve user experiences, drive
            innovation, and provide exceptional value.
          </p>
